    ...
    return (
        ...
        <div className="flex flex-col justify-center items-center pt-24 sm:pt-0 h-screen">
            <div className="flex flex-col space-y-2 w-10/12 sm:w-7/12">
                ...
                <p className='text-xl'>From an artistic background, I've worked 7 years as a <a className='font-bold'>video editor</a> and <a className='font-bold'>motion designer</a>. <br></br>In october 2022, I joined <a className="text-rose-400 font-bold hover:text-rose-600" href="https://adatechschool.fr/" target="_blank">ada tech school</a>, an inclusive programing school where I'm self-learning computer science by doing projects on different technologies. <br></br>I'm looking for a <a className='font-bold'>one year apprenticeship</a> in Paris as a full-stack developer.</p>
            
                <p className="text-zinc-800 text-2xl">Feel free to <a className="font-bold italic text-purple-400 hover:text-purple-600" href="https://www.linkedin.com/in/hugorince/" target="_blank">contact me</a></p>
