                            ...
                            <div class='flex flex-col space-y-8 justify-center items-center'>
                                ...
                                <div class="overflow-hidden  cursor-pointer relative group w-64 h-64 border border-zinc-800">
                                    ...
                                    <div onClick={()=>resultView(projects[i].name)}>
                                        <img
                                            alt=""
                                            class="object-cover w-full aspect-square group-hover:scale-105 hover:opacity-80 transition duration-300 ease-in-out"
                                            src={projects[i].img}
                                        />
                                    </div>
                                    </div>
                                ...
                                <div className='flex items-center justify-center mt-8'>
                                    <button className="bg-transparent hover:bg-zinc-400 text-zinc-800 font-semibold hover:text-zinc-100 py-2 px-4 border border-zinc-800 hover:border-transparent rounded" onClick={resetQuiz}>Skip to portfolio</button>
                                </div>
                            </div> 
                        </div>
