export default function ProjectsItems({projectClicked}){
    ...
    let projs = projects.map((project) => {
        ...
        <div className="overflow-hidden cursor-pointer relative group sm:w-48 h-48 lg:w-52 h-52 border border-zinc-800">
            ...
            <div onClick={() => {
                ...
                <img
                    alt=""
                    className="object-cover sm:w-48 h-48 lg:w-52 h-52 w-full aspect-square group-hover:scale-105 hover:opacity-60 transition duration-500 ease-in-out"
                    src={project.img}
