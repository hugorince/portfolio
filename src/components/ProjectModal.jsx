        ...
        if (projects[i].name === projectView){
            return (
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex flex-col items-end bg-zinc-100 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div style={{display: quizEnd ? 'block' : 'none'}}>
                            <div className="">
                            <button type="button" onClick={modalQuizClicked} className="bg-transparent hover:bg-zinc-400 text-zinc-800 font-semibold hover:text-zinc-100 py-2 px-4 hover:border-transparent rounded" data-modal-hide="defaultModal">
                            Go to portfolio
                            </button>
                            </div>
                        </div>
                        <div className="sm:flex sm:items-start">
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <div className="flex flex-col space-y-2">
                                    ...
                                    <p className="text-xs italic text-zinc-600">{projects[i].tech}</p>
                                </div>
                                <div className="mt-2 flex flex-col space-y-4">
                                    ...
                                    <img src={projects[i].img2} className="border border-zinc-800"></img>
                                    <img src={projects[i].img3} className="border border-zinc-800"></img>
                                    <img src={projects[i].img4} className="border border-zinc-800"></img>
                                    <img src={projects[i].img5} className="border border-zinc-800"></img>
                                </div>
                            </div>
                        </div>
                    </div>
